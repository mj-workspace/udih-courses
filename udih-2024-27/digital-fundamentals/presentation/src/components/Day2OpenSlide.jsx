export default function Day2OpenSlide() {
  const recap = [
    'Компютър — хардуер срещу софтуер; файлове в папки',
    'Интернет — мрежа от устройства; HTTPS и катинарче, внимание по обществен Wi-Fi',
    'Имейл — писма, календар, задачи; разпознаване на фишинг',
    'Мобилни устройства — телефонът е малък компютър; приложения само от официалния магазин',
    'Видеоконференции — една връзка за вход; микрофон изключен, когато не говорим',
    'Социални мрежи — четирите основни мрежи; какво слагаме в профила и какво — не',
  ]

  const today = [
    'Модул 6 (продължение) — задълбочаване, поверителност и сигурност',
    'Модул 7 — изкуствен интелект: ChatGPT, Claude, практическа работа',
    'Обобщение на курса и ключови изводи',
